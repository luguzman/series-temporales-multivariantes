...
#7. Diagnóstico del modelo. (Analizamos los residuos del modelo)
...
# esto lo que hará es ayudarnos con el tema de la varianza (Homoscedasticidad)
# más no con el tema de la media (estacionariedad) ya que se conitunará viendo una tendencia
