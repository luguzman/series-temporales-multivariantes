...
gdp <- ts(dat$gdp, start = c(1981, 2), freq = 4) # freq = 4, dado que la frequencia es trimentral y c(1981,2) es para indicarle el año y el trimestre en el que comienzan los datos.
